...
//             } ${darkScreen ? "bg-slate-500 text-slate-50" : "bg-slate-100 "}`}
  ...
  return (
    <div className="flex allPage">
      <div className="w-full overflow-hidden">
        <div className=" this flex flex-col bg-orange-500 overflow-hidden sticky top-0 ">
          <div className="flex flex-wrap  text-gray-50 w-screen flex-col items-center justify-l  ">
            <div
              className={`flex pl-4 w-screen overflow-auto bg-slate-200 h-16 items-center responsiveBtns ${
                darkScreen ? "bg-slate-600 text-slate-50 border-b border-zinc-800" : "bg-slate-300"
              } `}
            >
              <button
              ...
              >
                <FontAwesomeIcon
                  icon={faBold}
                  className={`font justify-center pl-2 text-slate-950 text-xl  ${
                    darkScreen ? "bg-transparent text-white" : ""
                  } `}
                />
                {hoveredButton == "bold" ? <p>Bold</p> : ""}
        ...
        <div className="flex w-auto filesDiv ">
          {!currentFile.length < 1 ? (
            <textarea
           className={`bg-slate-100 h-svh  overflow-y-scroll outline-none p-10 text-xl font-thin w-[100%]  border-r border-black ${
              smallScreen ? "show"  :"hide"
            } ${darkScreen ? "bg-slate-600 text-slate-50" : "bg-slate-100 "}`}
              placeholder="start writing here"
              id="userInput"
          ...
          <div
            className={`bg-slate-100  h-svh overflow-y-scroll outline-none p-10  text-xl font-thin w-[100%]  ${
              smallScreen ? "hide":'show' 
            } ${darkScreen ? "bg-slate-600 text-slate-50" : "bg-slate-100 "}`}
            id="htmlResponse"
            dangerouslySetInnerHTML={{ __html: htmlResponse }}
